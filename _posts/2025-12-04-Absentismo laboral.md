...
3. **Implementación del SAE:** Lanzar un **Servicio de Asistencia al Empleado (SAE[^1])** confidencial para soporte mental.
...
### 6.2. La Transparencia Algorítmica como Escudo Legal
